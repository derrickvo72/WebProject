                    ...
                    <div class="container-ls wrapX">
                        ...
                        <div style="width: 100%"  class="cart-icon">
                            ...
                            <div class="form-group">
                                ...
                                <input placeholder="Course name" type="text" class="form-control formX" autofocus>
                            </div>
                            <div class="form-group">
                                <div class="IDname">Language</div>
                                <input placeholder="ex: Java, C#,..." type="text" class="form-control formX" autofocus>
                            </div>
                        </div>
